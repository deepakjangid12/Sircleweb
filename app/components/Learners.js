...
const breakpoints = {
    ...
    return (
        <div className="  px-3 md:px-[120px]   ">
            <div className="flex items-center justify-center stroke-effect-s  md:text-6xl text-4xl font-medium   md:h-[154px]  my-16 text-white  ">
               <p className='stroke-effect-sm'> Hear it  from <br /> the Learners</p>
                </div>
            <Masonry
