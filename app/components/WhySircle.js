...
const ResponsiveLayout = () => {
  return (
    <div className="flex flex-col md:flex-row relative justify-center items-stretch bg-white md:h-[704px]"
       style={{ backgroundImage: "url('/Assets/vector.png')" }} // Ensure the background is applied correctly
>
      {/* Title Section */}
      {/* <div className="flex flex-col justify-center items-center w-full md:w-1/2 space-y-6 p-4">
        <div className="rounded-lg  overflow-hidden w-[426px] h-full">
          <div className="p-4 flex flex-col justify-center ">
            <h1 className="font-circle text-[59px] font-semibold leading-[90px] text-black text-left ">
              Why
            </h1>
            <h1 className="font-circle text-[94px] font-semibold leading-[95px] text-black text-left ">
              Sircle
            </h1>
            <p className="font-plex text-[20px] font-normal leading-[25px] text-black text-left mt-4 w-[300px]">
              Develop real-world skills with our courses designed by industry practitioners.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 space-y-6 p-4">
  <div className="rounded-lg overflow-hidden w-[426px] h-full flex flex-col justify-center">
      ...
      <div className="flex justify-center items-center w-full md:w-1/2 h-full">
        <div className="rounded-lg w-full max-w-[534px]   md:h-[600px] flex flex-col p-4">
          <div className="flex-1 grid grid-cols-2 gap-4 h-full">
            {/* Card 1 */}
            <div className="flex flex-col justify-center rounded-lg w-full h-full px-5 border-2 border-purple-800 bg-gradient-to-br from-[rgba(6,6,6,0.9)] to-[rgba(171,6,213,0.92)] text-white">
              <Image src="/Assets/frame1.png" height={70} width={70} alt="Personalized Guidance" className="mb-2 " />
              <h2 className="text-xl font-semibold px-1 my-1">Personalized<br />Guidance</h2>
            ...
            <div className="flex flex-col justify-center rounded-lg w-full h-full px-5 bg-white text-purple-800 border-2 border-purple-800">
              ...
              <h2 className="text-xl font-semibold px-1 my-1">Flexible<br />Interaction</h2>
            ...
            <div className="flex flex-col justify-center rounded-lg w-full h-full px-5 bg-white text-purple-800 border-2 border-purple-800">
              ...
              <h2 className="text-xl font-semibold px-1 my-1">Proven<br />Strategies</h2>
              <p className="text-sm py-2 px-1">Our mentors share battle-tested strategies that go beyond books.</p>
            </div>
            {/* Card 4 */}
            <div className="flex flex-col justify-center rounded-lg w-full h-full px-5 bg-white text-white  bg-gradient-to-br from-[rgba(6,6,6,0.9)] to-[rgba(171,6,213,0.92)]">
              <Image src="/Assets/frame4.png" height={70} width={70} alt="Join Sircle" className="mb-2" />
              <h2 className="text-xl font-semibold px-1 my-1">Join<br />Sircle</h2>
