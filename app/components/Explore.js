...
export default function Explore() {
    return (
        <>
            <div className="w-full  md:h-[483px] container mx-auto p-4  ">
                <h1 className="text-4xl font-Title font-bold text-center text-white mb-7 ">Explore the Programs</h1>
            ...
            {/* <div className="flex flex-col items-center  rounded-xl  w-full  h-auto mx-auto mt-8">
                <h2 className="text-lg font-bold text-center">Still Confused?</h2>
                <p className="text-sm text-center text-white">Talk To Counsellor
                    <Link href="#" className="text-purple-600 font-semibold inline-flex items-center ml-2">
                        <span className="text-center font-bold text-2xl">&rarr;</span>
                    </Link>
                </p>
            ...
            <div className='p-4'>
            <div className="flex items-center border-t-2 border-l-2 border-b-4 border-r-4 justify-between  text-white rounded-xl p-4 md:w-[600px] h-[126px]  mx-auto md:mt-8">
                <div className="flex-grow">
                    <h2 className="text-lg font-bold">Still Confused?</h2>
                    <p className="text-sm">Talk To Councellor
                        <a href="#" className="text-purple-600 font-semibold inline-flex items-center ml-2">
