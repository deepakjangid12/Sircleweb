...
// const FoundersNote = () => {
//   return (
//     <div className="flex flex-col md:flex-row mb-24 w-full md:px-[120px] bg-white text-black md:h-[600px] ">
//       <div className="w-full  md:w-1/2 ">
//       <div className=' relative border-2  md:w-[613px] md:h-[600px] border-red-500 '>
//       <div className='md:w-[483px] md:h-[355px] border-2 '>
...
//           <div>
//         <h1 className=" md:text-lg font-semibold block bg-white">And this is where Sircle comes in</h1>
//         </div>
...
const FoundersNote = () => {
  return (
    <div className="flex flex-col md:flex-row mb-24 w-full md:px-[120px] bg-whit text-black md:h-[600px] ">
      <div className="w-full md:w-1/2 flex  items-center justify-center order-0 md:order-1"> 
        <Image
          src="/Assets/aboutfounder.svg" // replace with your actual image path
          alt="Founder"
          width={300} // specify desired width
      ...
      <div className=" w-full md:w-1/2 flex  order-1 md:order-0 bg-white relative">
        <div className="flex mx-auto items-center px-5 border-2 w-[390px] h-[553px] md:w-[613px] md:h-[600px] ">
          <div className="md:w-[483px] md:h-[355px]  ">
            ...
            <div className='absolute rounded-md bottom-[-20px] w-[257px] h-[38px] mx-auto bg-purple-600  '>
      ...
      <div className='flex mx-auto order-2 bg-purple-600 rounded-md w-[330px] h-[216px]  mt-16'>
